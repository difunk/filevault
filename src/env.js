...
export const env = createEnv({
   ...
   * isn't built with invalid env vars. When missing during buld/deploy, we get an error specifying what is missing
   */
  server: {
  ...
  client: {
    ...
    NEXT_PUBLIC_APP_URL: z.string().default("https://goo-drive.netlify.app"),
  },
